...
const ProductsTemplate = () => {
    ...
    featuredProducts=window.innerWidth>640?window.innerWidth>768?featuredProducts:featuredProducts.slice(0,4):featuredProducts.slice(0,3)
            ...
            return (
              <div key={i} className="">
                ...
                <div className="flex justify-around align-middle py-2">
                  <div>
                    <h3 className="font-bold text-[0.70rem] lg:text-base md:text-base pt-[6px] md:pt-[0px] lg:pt-[0px]">&#x20B9;{price}</h3>
                  </div>
                  <div>
                    <h3 className="">
